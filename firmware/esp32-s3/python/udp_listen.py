...
Runs anywhere the stream is sent -- normally this laptop, next to `make start` -- and shows what
the pipeline would see. Standard library only. Header format: see main.py.
"""
import argparse
import socket
import struct
