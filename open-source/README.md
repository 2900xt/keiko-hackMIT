...
- `index.html` — three panels: live map, buoy status (ID, state, position), live spectrogram
- `style.css` — white, Helvetica
- `synthetic.js` — fake feed: `telemetry` every 2 s, `audio` (spectrogram column) 20×/s
- `app.js` — draws it
