...
| `audio/<dataset>/<taxon or label>/*.wav` | 95,350 extracted clips (16 GB). Every file has a row in `clips`. |
...
Totals: **95,350 clips, ~71 hours, 59 species with audio** (30 toothed whales, 8 baleen whales, 14 pinnipeds,
6 fish, 1 sea otter) plus family-level and unidentified classes. Species with the most audio: oyster toadfish
(10k), plainfin midshipman (4.7k), killer whale (3.5k), humpback (3.1k), sperm whale (1.3k, 11.7 h).
...
- `datasets`: 75 datasets from the papers (DCLDE 2013–2027, NOAA NEFSC/PIFSC/SanctSound, Antarctic blue/fin
  ...
  label format, license and the papers that used them. `downloaded=1` marks the seven with audio here.
...
- Class imbalance is severe. Toadfish and midshipman dominate fish; common dolphin and false killer whale dominate Watkins.
